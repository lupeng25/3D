...
#ifndef _QTPROPERTY1_EXPORT_
#define _QTPROPERTY1_API_ _declspec(dllexport)
#else
#define _QTPROPERTY1_API_ _declspec(dllimport)
...
class _QTPROPERTY1_API_ QtCursorDatabase
{
public:
    QtCursorDatabase();
    void clear();
...
class _QTPROPERTY1_API_ QtPropertyBrowserUtils
{
public:
...
class _QTPROPERTY1_API_ QtBoolEdit : public QWidget {
    Q_OBJECT
public:
