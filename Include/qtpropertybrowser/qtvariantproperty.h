...
class _QTPROPERTY_API_ QtVariantProperty : public QtProperty
{
public:
    ~QtVariantProperty();
...
class _QTPROPERTY_API_ QtVariantPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class _QTPROPERTY_API_ QtVariantEditorFactory : public QtAbstractEditorFactory<QtVariantPropertyManager>
{
    Q_OBJECT
public:
