...
#ifndef _QTPROPERTY_EXPORT_
#define _QTPROPERTY_API_ _declspec(dllexport)
#else
#define _QTPROPERTY_API_ _declspec(dllimport)
...
class _QTPROPERTY_API_ QtProperty
{
public:
    virtual ~QtProperty();
...
class _QTPROPERTY_API_ QtAbstractPropertyManager : public QObject
{
    Q_OBJECT
public:
...
class _QTPROPERTY_API_ QtAbstractEditorFactoryBase : public QObject
{
    Q_OBJECT
public:
...
class _QTPROPERTY_API_ QtAbstractEditorFactory : public QtAbstractEditorFactoryBase
{
public:
...
class _QTPROPERTY_API_ QtBrowserItem
{
public:
...
class _QTPROPERTY_API_ QtAbstractPropertyBrowser : public QWidget
{
    Q_OBJECT
public:
