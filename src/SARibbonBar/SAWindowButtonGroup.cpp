...
public:
    ...
    void setupMinimizeButton(bool on)
    {
        ...
        if (on) {
            ...
            buttonMinimize->setFixedSize(40, RibbonSubElementStyleOpt.titleBarHeight() + 5);
    ...
    void setupMaximizeButton(bool on)
    {
        ...
        if (on) {
            ...
            buttonMaximize->setFixedSize(40, RibbonSubElementStyleOpt.titleBarHeight() + 5);
    ...
    void setupCloseButton(bool on)
    {
        ...
        if (on) {
            ...
            buttonClose->setFixedSize(40, RibbonSubElementStyleOpt.titleBarHeight() + 5);
    ...
    {
        int width  = 0;
        int height = RibbonSubElementStyleOpt.titleBarHeight() + 5;
