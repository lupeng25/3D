...
class _QTPROPERTY_API_ QtTreePropertyBrowserPrivate
{
...
class _QTPROPERTY_API_ QtPropertyEditorView : public QTreeWidget
{
    Q_OBJECT
public:
...
class _QTPROPERTY_API_ QtPropertyEditorDelegate : public QItemDelegate
{
    Q_OBJECT
public:
