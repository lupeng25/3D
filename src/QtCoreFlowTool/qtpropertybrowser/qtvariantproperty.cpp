...
class _QTPROPERTY_API_ QtEnumPropertyType
{
};


class _QTPROPERTY_API_ QtFlagPropertyType
{
};


class _QTPROPERTY_API_ QtGroupPropertyType
{
};
...
class _QTPROPERTY_API_ QtVariantPropertyPrivate
{
public:
...
class _QTPROPERTY_API_ QtVariantPropertyManagerPrivate
{
...
class _QTPROPERTY_API_ QtVariantEditorFactoryPrivate
{
