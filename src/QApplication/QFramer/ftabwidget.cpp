...
bool FTabWidget::CheckPageAvalible()
{
	return false;
}

int FTabWidget::CloseUI()
{
	return 0;
}

int FTabWidget::initData(QString& strError)
{
	return 0;
}
...
//    widget->setObjectName(objectName);
	...
	m_vecpWidget.append((QtWidgetsBase*)widget);
