...
void FNavgationBar::setAlignment_topLeft()
{
    ...
    mainlayout_topLeft->setContentsMargins(2, 2, 2, 2);
...
void FNavgationBar::setAlignment_topCenter()
{
    ...
    mainlayout_topCenter->addStretch();
    mainlayout_topCenter->setContentsMargins(2, 2, 2, 2);
...
void FNavgationBar::setAlignment_topRight()
{
    ...
    mainlayout_topRight->setContentsMargins(2, 2, 2, 2);
...
void FNavgationBar::setAlignment_bottomLeft()
{
    ...
    mainlayout_bottomLeft->setContentsMargins(2, 2, 2, 2);
...
void FNavgationBar::setAlignment_bottomCenter()
{
    ...
    mainlayout_bottomCenter->addStretch();
    mainlayout_bottomCenter->setContentsMargins(2, 2, 2, 2);
...
void FNavgationBar::setAlignment_bottomRight()
{
    ...
    mainlayout_bottomRight->setContentsMargins(2, 2, 2, 2);
...
void FNavgationBar::setAlignment_leftTop()
{
    ...
    mainlayout_leftTop->setContentsMargins(2, 2, 2, 2);
...
void FNavgationBar::setAlignment_leftCenter()
{
    ...
    mainlayout_leftCenter->addStretch();
    mainlayout_leftCenter->setContentsMargins(2, 2, 2, 2);
...
void FNavgationBar::setAlignment_leftBottom()
{
    ...
    mainlayout_leftBottom->setContentsMargins(2, 2, 2, 2);
...
void FNavgationBar::setAlignment_rightTop()
{
    ...
    mainlayout_rightTop->setContentsMargins(2, 2, 2, 2);
...
void FNavgationBar::setAlignment_rightCenter()
{
    ...
    mainlayout_rightCenter->addStretch();
    mainlayout_rightCenter->setContentsMargins(2, 2, 2, 2);
...
void FNavgationBar::setAlignment_rightBottom()
{
    ...
    mainlayout_rightBottom->setContentsMargins(2, 2, 2, 2);
...
void FNavgationBar::setButtonChecked()
{
	...
	int _iCheckedIndex = -1;
	for (int i = 0; i < buttons.size(); i++)
	{
		if (buttons.at(i) == sender())
		{
			bool bChange = emit indexChanged(i);
			bRequestOK &= bChange;
			if (!bChange)
				buttons.at(i)->setChecked(false);
			emit sigButtonClicked(i);
		}
	}
	if (bRequestOK)
	{
