...
class MyMessageBox : public FBaseDialog {
	Q_OBJECT
...
public:
	...
	~MyMessageBox();
	static void CenterWindow(QWidget * window, QWidget * subwindow);
	void SetMessageBox(Icon icon, const QString& text, const QString& title, StandardButtons buttons = Ok);
public:
	void init();
	...
	static StandardButton showMessageBox(QWidget* parent, Icon icon, const QString& text, QString title = "Message", StandardButtons buttons = Ok);
	static StandardButton WaitForShowMessageBox(QWidget* parent, Icon icon, const QString& text, QString title = "Message", StandardButtons buttons = Ok);

	static void setMessageBoxGeometry(QWidget* parent, MyMessageBox& msgBox);
	StandardButton WaitShowMessageBox(QWidget* parent, Icon icon, const QString& text, QString title = "Message", StandardButtons buttons = Ok);
private slots:
