...
IPAddress::IPAddress(QWidget* parent) : QWidget(parent)
{
	...
	//用于显示小圆点的标签
	labDot1 = new QLabel;
	labDot1->setObjectName("qlabDot1");
	labDot1->setStyleSheet("color: rgb(0, 0, 200);font: 10pt Microsoft YaHei;");
	labDot1->setAlignment(Qt::AlignCenter);
	labDot1->setText(".");
	labDot1->setMaximumWidth(30);
	labDot1->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Expanding);

	labDot2 = new QLabel;
	labDot2->setObjectName("qlabDot2");
	labDot2->setStyleSheet("color: rgb(0, 0, 200);font: 10pt Microsoft YaHei;");
	labDot2->setAlignment(Qt::AlignCenter);
	labDot2->setText(".");
	labDot2->setMaximumWidth(30);
	labDot2->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Expanding);

	labDot3 = new QLabel;
	labDot3->setObjectName("qlabDot3");
	labDot3->setStyleSheet("color: rgb(0, 0, 200);font: 10pt Microsoft YaHei;");
	labDot3->setAlignment(Qt::AlignCenter);
	labDot3->setText(".");
	labDot3->setMaximumWidth(30);
	labDot3->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Expanding);
	//用于输入IP地址的文本框
	txtIP1 = new QLineEdit;	
	txtIP1->setObjectName("txtIP1");
	txtIP1->setStyleSheet("color: rgb(0, 0, 200);font: 10.5pt Microsoft YaHei;");
	...
	txtIP2->setStyleSheet("color: rgb(0, 0, 200);font: 10.5pt Microsoft YaHei;");
	...
	txtIP3->setStyleSheet("color: rgb(0, 0, 200);font: 10.5pt Microsoft YaHei;");
	...
	txtIP4->setStyleSheet("color: rgb(0, 0, 200);font: 10.5pt Microsoft YaHei;");
...
IPAddress::~IPAddress()
{
	if (labDot1 != nullptr) delete labDot1; labDot1 = nullptr;
	if (labDot2 != nullptr) delete labDot2; labDot2 = nullptr;
	if (labDot3 != nullptr) delete labDot3; labDot3 = nullptr;
	if (txtIP1 != nullptr)	delete txtIP1;	txtIP1 = nullptr;
	if (txtIP2 != nullptr)	delete txtIP2;	txtIP2 = nullptr;
	if (txtIP3 != nullptr)	delete txtIP3;	txtIP3 = nullptr;
	if (txtIP4 != nullptr)	delete txtIP4;	txtIP4 = nullptr;
	if (frame != nullptr)	delete frame;	frame = nullptr;
	if (verticalLayout != nullptr)	delete verticalLayout;	verticalLayout = nullptr;
