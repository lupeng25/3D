	...
	: QWidget(parent)
{
	...
	//m_accountNumber->setStyleSheet("QWidget{background-color: transparent;color:white;}");
	//m_accountImage->setStyleSheet("background-color:transparent;");
	//m_accountImage->setStyleSheet("QWidget{background-color: transparent;color:white;}");
	//setStyleSheet("QWidget{background-color: #bcc2bc;border: 1px solid white;}");
...
void AccountItem::setAccountInfo(int index, const userInfo& info)
{
	...
	QString accountName = QStringLiteral("%1").arg(info.userId)/*.arg(strElidedText)*/;
	//设置用户名+用户Id
