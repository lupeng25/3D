...
{
    setSkinForApp(QString(":/skin/icon/qss/BW.qss"));
}

void ThemeMenu::changeTheme2()
{
    setSkinForApp(QString(":/skin/icon/qss/BB.qss"));
}

void ThemeMenu::changeTheme3()
{
    setSkinForApp(QString(":/skin/icon/qss/GB.qss"));
}

void ThemeMenu::changeTheme4()
{
    setSkinForApp(QString(":/skin/icon/qss/GG.qss"));
}

void ThemeMenu::changeTheme5()
{
    setSkinForApp(QString(":/skin/icon/qss/GBG.qss"));
}

void ThemeMenu::changeTheme6()
{
    setSkinForApp(QString(":/skin/icon/qss/GGG.qss"));
}
