...
/// Profile information
typedef struct {
	BYTE	byProfileCount;		// Fixed to 1.(reserved for future use)
...
extern "C"
{
	...
	*/
	...
	@return	Return code
	*/
	LJX8_IF_API LONG WINAPI LJX8IF_SetTimerCount(LONG lDeviceId, DWORD dwTimerCount);
	...
	@return	Return code
	*/
	LJX8_IF_API LONG WINAPI LJX8IF_GetTimerCount(LONG lDeviceId, DWORD* pdwTimerCount);
	...
	*/
	...
	@return	Return code
	*/
	LJX8_IF_API LONG WINAPI LJX8IF_GetHeadModel(LONG lDeviceId, CHAR* pHeadModel);
	...
	*/
	...
	@return	Return code
	*/
	LJX8_IF_API LONG WINAPI LJX8IF_GetLedLightImage(LONG lDeviceId, BYTE byLedBrightness, BYTE byLaserBrightness, BYTE* pbyImageData);
	...
	*/
	...
	@return	Return code
	*/
	LJX8_IF_API LONG WINAPI LJX8IF_SetXpitch(LONG lDeviceId, DWORD dwXpitch);
	...
	@return	Return code
	*/
	LJX8_IF_API LONG WINAPI LJX8IF_GetXpitch(LONG lDeviceId, DWORD* pdwXpitch);
	...
	*/
	...
	@return	Return code
	*/
	LJX8_IF_API LONG WINAPI LJX8IF_GetZUnitSimpleArray(LONG lDeviceId, WORD* pwZUnit);


	// Utility Function related
	/**
	Stitch together the multiple images 
	@param	bPixel			The number of bytes per pixel.
	...
	@return	Return code
	*/
	LJX8_IF_API LONG WINAPI LJX8IF_CombineImage(BYTE bPixel, LONG lNumX, LONG lNumY, LONG lSizeX, LONG lSizeY, LONG *plOpSort,
		BYTE *pbOpInvX, BYTE *pBOpInvY,	LONG *plOpCutX,	LONG *plOpGeoX, LONG *plOpGeoY,	void *pSourceImage,	void *pDestImage);
	...
	@return	Return code
	*/
	LJX8_IF_API LONG WINAPI LJX8IF_CircularImage(LONG lXPointNum, LONG lProfileNum, FLOAT fCircleCenterXUm, FLOAT fThetaPitchDeg, FLOAT fTiltCorrectDeg,
		FLOAT fXPitchUm, FLOAT fZUnit, BYTE byImageType, LONG lDestXPointNum, LONG lDestYPointNumP, LONG lDestYPointNumM, void* pSourceImage, void* pDestImage);
	...
	@return	Return code
	*/
	LJX8_IF_API LONG WINAPI LJX8IF_CircularImagePointCloud(LONG lXPointNum, LONG lProfileNum, FLOAT fCircleCenterXUm, FLOAT fThetaPitchDeg,
	...
	@return	Return code
	*/
	LJX8_IF_API LONG WINAPI LJX8IF_SpecialCommandInitialize(LONG lDeviceId);
	...
	@return	Return code
	*/
	LJX8_IF_API LONG WINAPI LJX8IF_SpecialCommandEncoder(LONG lDeviceId, BYTE byEncoderTriggerInputMode, WORD wSkippingPoints, BYTE byEncoderMinimumInputTime);
