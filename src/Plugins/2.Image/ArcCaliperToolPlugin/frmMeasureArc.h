...
class frmMeasureArc : public frmBaseTool
{
	Q_OBJECT

//必然包含的组件函数和变量
public:
	frmMeasureArc(QWidget* parent = Q_NULLPTR);
	~frmMeasureArc();

private:
	Ui::frmMeasureArcClass ui;
...
public:
	static QVector<ArcCaliperP> QJsonToShapeData(QJsonArray &RegionData);
private slots:
