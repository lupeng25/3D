...
/*
	enum Stat
	{
		...
		ERR_PC_WRAPED,				// "przewiniêcie si? licznika rozkazów
		...
		ERR_BAD_REPT_NUM,			// b³¹dna iloœæ powtórze?(dozwolone od 0 do 0xFFFF)
		ERR_SPURIOUS_ENDR,			// wyst¹pienie .ENDR bez odpowiadaj¹cego mu .REPEAT
		ERR_INCLUDE_NOT_ALLOWED,	// dyrektywa .INCLUDE nie mo¿e wystêpowa?w makrach i powtórkach
